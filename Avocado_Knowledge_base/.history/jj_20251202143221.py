...
if 'kb_initialized' not in st.session_state:
    ...
    # --- DEFINE RULES (must come after all facts are loaded) ---
    # Import the terms as Python objects for rule definition
    from pyDatalog import pyDatalog
...
# Import terms for querying
from pyDatalog import pyDatalog

# Get term objects for queries
pest = pyDatalog.terms.pest
disease = pyDatalog.terms.disease
